...
function openConversation(id) {
    ...
    getEl('saveConversationStatus')?.addEventListener(
        'click',
        async () => {

            const status =
                getEl('conversationStatus')?.value ||
                'Aguardando';

            const saveBtn =
                getEl('saveConversationStatus');
            ...
            if (!conv._row) {
                ...
                showToast(
                    'Não foi possível identificar a conversa na planilha.'
                );
    ...
    getEl('scheduleFromConversation')?.addEventListener(
        'click',
        () => {
